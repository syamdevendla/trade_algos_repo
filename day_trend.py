...
print("Value Area High: Price = ", value_area_high['Price'], " Volume = ", value_area_high['Volume'])
print("Value Area Low: Price = ", value_area_low['Price'], " Volume = ", value_area_low['Volume'])